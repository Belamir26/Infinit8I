...
def acq_sensor_data(name,grip, tag, labeltimer, destime, labelestado):
    ...
    accion=0
    last_action_time=0
    label_numacc.set("#Action " + str(accion))
    rest_duration=3
    action_duration=5
    current_set=0
    ...
    while time.time() < end_time:
        ...
        if elapsed_time % (rest_duration + action_duration) < rest_duration:
            ...
            labelestado.config(text="Rest: "+ str(tiempo_set), background="#22a374")
        else:
            tiempo_set = seconds- (((current_set- 1) * 8) -3   +1) + (minutes *60) -4
            labelestado.config(text="Action: "+ str(tiempo_set), background="#CB4154")
...
btProceso = Button(frame3,command= bt_proceso, text= "Process ",bg="white",fg="black", font="Helvetica 14 bold",width=12)
btReanudar = Button(frame3,command= reanudar, text= "Resume ",bg="white",fg="black", font="Helvetica 14 bold",width=12)
btPausar = Button(frame3,command= pausar, text= "Stop ",bg="white",fg="black", font="Helvetica 14 bold",width=12)
btSalir = Button(frame3,command= salir, text= "Exit ",bg="white",fg="black", font="Helvetica 14 bold",width=12)
...
btConectar = Button(frame4,command= conectar, text= "Connect ",bg="white",fg="black", font="Helvetica 14 bold",width=12,justify="center")
btActualizar = Button(frame4,command= actualizar_COM, text= "Update COM ",bg="white",fg="black", font="Helvetica 14 bold",width=12,justify="center")
...
label_numacc= StringVar(frame5, "#Action 0")
...
labelestado = Label(frame5,text="Rest/Action", bg= "#85b7e9",fg="black", font="Helvetica 14 bold",width=12 ,justify="left")
